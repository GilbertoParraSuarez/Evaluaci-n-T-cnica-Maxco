  ...
  <AuthenticatedLayout>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div class="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <!-- Vendedores Activos -->
        <div
          class="overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg ring-1 ring-black/5">
          <div class="p-6">
        ...
        <!-- Zonas Activas -->
        <div
          class="overflow-hidden rounded-xl bg-gradient-to-r from-green-500 to-green-600 shadow-lg ring-1 ring-black/5">
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div class="flex-shrink-0">
        ...
        <!-- Total Clientes -->
        <div
          class="overflow-hidden rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 shadow-lg ring-1 ring-black/5">
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div class="flex-shrink-0">
      ...
      <div class="mb-8 overflow-hidden rounded-xl bg-white shadow-lg border border-gray-100">
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-5">
            ...
            <div v-if="hasDateFilters" class="col-span-2 flex items-center text-sm text-gray-600 self-end mb-2">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="(record, index) in topZonaPorVendedor" :key="`${record.id_vendedor}-${record.id_zona}`"
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-lg border border-gray-100">
          <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
              ...
              <button @click="exportZonasPorVendedor" class="text-sm text-green-600 hover:text-green-700 font-medium">
                Exportar
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600">
                {{ hasDateFilters ? `Zonas sin ventas entre ${formatDate(filters.desde)} y ${formatDate(filters.hasta)}`
                  : 'Selecciona un período para ver zonas inactivas' }}
              </p>
            </div>
            <div class="flex items-center gap-3">
              <button @click="exportZonasSinVentas" class="text-sm text-yellow-700 hover:text-yellow-800 font-medium">
                Exportar
              </button>
      ...
      <div class="mb-8 overflow-hidden rounded-xl bg-white shadow-lg border border-gray-100">
        <div class="bg-gradient-to-r from-red-50 to-pink-50 px-6 py-4 border-b border-gray-200">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600">
                {{ hasDateFilters ? `Vendedores sin ventas entre ${formatDate(filters.desde)} y
                ${formatDate(filters.hasta)}` : 'Selecciona un período para ver vendedores inactivos' }}
              </p>
            </div>
            <div class="flex items-center gap-3">
              <button @click="exportVendedoresSinVentas" class="text-sm text-red-600 hover:text-red-700 font-medium">
                Exportar
              </button>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr v-for="vendedor in vendedoresSinVentas" :key="vendedor.id_vendedor"
              ...
              <tr v-if="!vendedoresSinVentas?.length">
                <td colspan="2" class="px-6 py-8 text-center text-gray-500">
                  {{ hasDateFilters ? 'Todos los vendedores tienen actividad en el período seleccionado' : 'Seleccionaun período de fechas para ver vendedores sin actividad'
                  }}
                </td>
              </tr>
            </tbody>
      ...
      <div v-if="Object.keys(totalVentasPorAnio).length"
        ...
        <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
          <div class="flex items-center justify-between">
            ...
            <button @click="exportResumenAnual" class="text-sm text-purple-700 hover:text-purple-800 font-medium">
              Exportar
            </button>
          </div>
        </div>
      ...
      <div class="mb-8 overflow-hidden rounded-xl bg-white shadow-lg border border-gray-100">
        <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-6 py-4 border-b border-gray-200">
          <div class="flex items-center justify-between">
            ...
            <button @click="exportClientesPivot" class="text-sm text-emerald-600 hover:text-emerald-700 font-medium">
              Exportar
            </button>
          </div>
        </div>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr v-for="(cliente, index) in clientSalesPivot" :key="cliente.id_cliente"
                :class="index % 2 === 0 ? 'bg-white' : 'bg-gray-50'" class="hover:bg-emerald-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap">
